...
DefaultTableModel dtm;
	...
	dtm=new DefaultTableModel(null,Field);
		...
		ResultSet rs;
			...
			rs=smt.executeQuery("select *from ask");
	...
	while(rs.next()){
	 ...
	 String Gender1=rs.getString(2);
		...
		header.setBackground(Color.getHSBColor(2, 2,2));
		 dtm.addRow(Rows);
	}
    ...
    private void initComponents() {
        ...
        jPanel6.add(jPanel7);
        jPanel7.setBounds(20, 20, 650, 430);

        jPanel4.add(jPanel6);
        jPanel6.setBounds(230, 20, 690, 480);
        ...
        jPanel1.add(jPanel3);
        jPanel3.setBounds(12, 108, 970, 560);
