 ...
 * 
 */
public class Qview extends javax.swing.JFrame {
DefaultTableModel dtm;
    ...
    String Field[]={"QId","Quiz Titile","Questions"};
	dtm=new DefaultTableModel(null,Field);
		...
		ResultSet rs;
			...
			rs=smt.executeQuery("select *from quiz");


	while(rs.next()){
	 String Name1=rs.getString(8);
    ...
    private void initComponents() {
        ...
        jPanel6.add(jPanel7);
        jPanel7.setBounds(20, 20, 660, 370);

        jPanel4.add(jPanel6);
        jPanel6.setBounds(220, 30, 710, 420);
        ...
        jPanel4.add(jPanel5);
        jPanel5.setBounds(0, 10, 210, 500);
        ...
        jPanel1.setBounds(0, 10, 1030, 630);
