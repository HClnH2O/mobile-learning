...
public void vertical(){
    String Field[]={"Name","Quiz Attended","Mark Scored"};
	dtm=new DefaultTableModel(null,Field);
		...
		ResultSet rs;
			...
			rs=smt.executeQuery("select *from result");
	...
	while(rs.next()){
	 ...
	 String Gender1=rs.getString(3);
		...
		String[] Rows={Name1,Pass1,Gender1};
		...
		header.setBackground(Color.getHSBColor(3, 3,3));
		 dtm.addRow(Rows);
	}
    ...
    private void initComponents() {
        ...
        setBounds(new java.awt.Rectangle(0, 0, 1023, 750));
        ...
        jPanel6.add(jPanel7);
        jPanel7.setBounds(10, 20, 690, 350);

        jPanel4.add(jPanel6);
        jPanel6.setBounds(230, 30, 720, 420);
        ...
        jPanel1.add(jPanel3);
        jPanel3.setBounds(12, 108, 980, 550);

        getContentPane().add(jPanel1);
        jPanel1.setBounds(0, 10, 1010, 700);
